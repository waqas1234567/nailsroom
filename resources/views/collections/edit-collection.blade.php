...
@section('content')
    ...
    <form  action="/marki/edytuj-kolekcje" method="post" >
        @csrf
        ...
        <div class="starter-template">
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <input type="hidden" name="brand_id" value="{{$collection->brand_id}}">

                    <div class="col-md-10 " id="nazwa-field">
                        <div class="group">
                            <input type="text" value="{{$collection->name}}" name="collection" required>
