@extends('layouts.admin_layout')
  @section('content')
      ...
      <form  action="/add-newsy" method="post" enctype="multipart/form-data">
          @csrf
          ...
          @endif
              <div class="col-md-8">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-10">
                          <textarea  rows="10" cols="15" name="contents"  class="form-control mt-4" required></textarea>
                      </div>
                  </div>
                  <div class="row">
                      <div class="col-md-2">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-10">
                          ...
                          <input type="file" id="myfile" name="image"  class="btn  custom-btn-2" required>
