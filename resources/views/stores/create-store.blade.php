                ...
                <div class="col-md-4 col-sm-12">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center mb-1">
                            <span><input  type="checkbox" id="brandCheckbox{{$b->id}}" onchange="enableButton({{$b->id}})" name="brands[]" value="{{$b->id}}" class="gridCheck1"><label>{{$b->name}}</label></span>
{{--                            <span class="table-span">{{$b->name}}</span>--}}
                            <span>

                    <button type="button"  onclick="getCollections({{$b->id}})" id="storeButton{{$b->id}}" data-toggle="modal" data-target="#exampleModal" class="btn custom-btn-style " disabled>Kolekcje</button>
                </span>
